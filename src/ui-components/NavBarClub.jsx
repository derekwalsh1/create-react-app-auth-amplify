...
import { CurrentViewInfo } from "../models";
...
export default function NavBarClub(props) {
  const { appSettings, currentViewInfo, DASHBOARD, overrides, ...rest } = props;
  const [latestNewsBackgroundColor, setLatestNewsBackgroundColor] =
    useStateMutationAction(undefined);
  const latestNewsOnMouseOver = () => {
    setLatestNewsBackgroundColor("gray");
  };
  const latestNewsOnMouseLeave = () => {
    setLatestNewsBackgroundColor("white");
  };
  const latestNewsOnClick = useDataStoreUpdateAction({
    fields: { CurrentView: "5\n\n" },
    id: DASHBOARD,
    model: CurrentViewInfo,
    schema: schema,
  });
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "NavBarClub")}
    >
      <Flex
        gap="2px"
        direction="row"
        ...
        {...getOverrideProps(overrides, "Club Name & Icon")}
      >
        <Icon
          width="18px"
          height="18px"
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "Icon29767074")}
        ></Icon>
        <Text
          fontFamily="Inter"
          fontSize="20px"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Bay Area Storm Volleyball"
          {...getOverrideProps(overrides, "Club Name")}
        ></Text>
      </Flex>
      <Flex
        gap="40px"
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Menu Item Frame")}
      >
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Dashboard"
          backgroundColor={latestNewsBackgroundColor}
          onMouseOver={() => {
            latestNewsOnMouseOver();
          }}
          onMouseLeave={() => {
            latestNewsOnMouseLeave();
          }}
          onClick={() => {
            latestNewsOnClick();
          }}
          {...getOverrideProps(overrides, "Latest News")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Our Coaching Staff"
          {...getOverrideProps(overrides, "Coaches")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Search Frame")}
      >
        <SearchField
          display="flex"
          gap="8px"
