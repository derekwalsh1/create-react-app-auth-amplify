...
export default function CreateActivity(props) {
  ...
  const buttonOnClick = useDataStoreCreateAction({
    fields: {
      Title: textFieldTwoNineSevenSixSixNineThreeSixValue,
      Description: textFieldTwoNineSevenSixSixNineThreeEightValue,
      Cost: textFieldTwoNineSevenSixSixNineThreeNineValue,
    },
    model: Activities,
    schema: schema,
  });
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "CreateActivity")}
    >
      <Flex
        gap="8px"
        direction="column"
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "Create New Activity")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Fill out the details below and click submit to add a new activity to the activities list."
          {...getOverrideProps(
            overrides,
            "Fill out the details below and click submit to add a new activity to the activities list."
          )}
        ></Text>
      </Flex>
      <Flex
